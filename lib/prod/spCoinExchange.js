...
async swapExactOutputSingle (
  ...
  async getQuoterPrice(
    ...
    _sqrtPriceLimitX96 ) {
      ...
      let quotePrice = await this.spCoinExchangeContract.getQuoterPrice (
        _tokenIn, 
        _tokenOut, 
        _poolFee, 
        _amountIn, 
      ...
      console.log("=======================================================================");
      console.log("spCoinExchange.js:quotePrice =", quotePrice);
      // let quotePrice = tx.wait();

      // console.log("=======================================================================");
      // console.log("spCoinExchange.js:quotePrice =", await quotePrice);
      // console.log("=======================================================================");
      return quotePrice;
   }
   ...
   async testUInt(
    ...
    _sqrtPriceLimitX96
      ...
      let uint = await this.spCoinExchangeContract.testUInt(_tokenIn, 
        _tokenOut, 
        _poolFee, 
        _amountIn, 
        _sqrtPriceLimitX96);
      ...
      console.log("=======================================================================");
      console.log("this.spCoinExchangeContract.testUInt =", uint);
      return uint;
   }
